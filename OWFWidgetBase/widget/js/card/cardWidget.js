...
define(function() {
    ...
    CardWidget.prototype.importHTML = function(data) {
        var self = this;
    ...
    CardWidget.prototype.initialize = function(data, options) {
        var self = this;
    ...
    CardWidget.prototype._create = function (data) {
        var self = this;
    ...
    CardWidget.prototype.onClick = function (event) {
        var self = this;
