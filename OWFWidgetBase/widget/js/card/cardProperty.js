...
define(function() {
    ...
    CardProperty.prototype.importHTML = function(data) {
        var self = this;
    ...
    CardProperty.prototype.initialize = function(data, options) {
        var self = this;
    ...
    CardProperty.prototype._create = function (data) {
        var self = this;
    ...
    CardProperty.prototype.onClick = function (event) {
        var self = this;
